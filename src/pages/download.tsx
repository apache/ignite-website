            ...
            <div className={styles.extensionsBlock} id="extensions">
              ...
              <div className={styles.extensionGrid}>
                {extensionSourceReleases.map((ext) => {
                  ...
                  // Build closer.lua links for extension artifacts too
                  const sourceResolved = resolveMirrorUrl(ext.sourceUrl, preferredMirror);
                  const sourceHref = toCloserUrl(sourceResolved);

                  const binaryHref = binaryRelease?.binaryUrl
                      ? toCloserUrl(resolveMirrorUrl(binaryRelease.binaryUrl, preferredMirror))
                      : undefined;
