    ...
    [
      '@docusaurus/plugin-client-redirects',
      {
        redirects: [
          ...
          { from: '/blog/in/', to: '/blog/tags/in-memory' },
          { from: '/blog/memory/', to: '/blog/tags/in-memory' },
          { from: '/blog/open/', to: '/blog/tags/open-source' },
          { from: '/blog/source/', to: '/blog/tags/open-source' },
