 ...
 * Generated from historical PUG templates
...
export const EVENTS: Event[] = [
  ...
  {
    id: '2021-29-apache-ignite-essentials-key-design-principles-for',
  ...
  {
    id: '2021-32-designing-in-memory-applications-for-cloud-deploym',
    title: "Designing In Memory Applications for Cloud Deployment",
    type: 'conference',
    date: '2021-01-01',
    location: "DeveloperWeek",
  ...
  {
    id: '2021-33-pro-workshop-in-memory-computing-how-to-fight-your',
    title: "PRO WORKSHOP: In-Memory Computing: How to Fight Your Serverless Code's Idle Time",
    type: 'virtual',
    date: '2021-01-01',
    location: "DeveloperWeek Virtual",
  ...
  {
    id: '2021-34-detecting-potential-hazardous-situations-in-the-du',
    title: "Detecting Potential Hazardous Situations in the Dutch Railway Planning with Apache Ignite",
    type: 'meetup',
    date: '2021-01-01',
    location: "Virtual Apache Ignite\u00ae Meetup",
  ...
  {
    id: '2021-35-apache-ignite-essentials-key-design-principles-for',
    title: "Apache Ignite Essentials - Key Design Principles for Building Data-Intensive Applications",
    type: 'webinar',
    date: '2021-01-01',
    location: "Developer Training",
  ...
  {
    id: '2021-36-enabling-real-time-analytics-for-data-lakes-with-a',
    title: "Enabling Real-Time Analytics for Data Lakes with Apache Ignite",
    type: 'conference',
    date: '2021-01-01',
    location: "Subsurface: Cloud Data Lake conf",
  ...
  {
    id: '2021-37-apache-ignite-300-alpha-build-community-gathering',
    title: "Apache Ignite 3.0.0 Alpha Build Community Gathering",
    type: 'meetup',
    date: '2021-01-01',
    location: "Virtual Apache Ignite\u00ae Meetup",
  ...
  {
    id: '2020-45-learn-apache-ignite-through-coding-examples',
    title: "Learn Apache Ignite Through Coding Examples",
    type: 'webinar',
    date: '2020-01-01',
    location: "Webinar",
  ...
  {
    id: '2020-60-how-to-boost-and-scale-postgres-from-sharding-to-i',
  ...
  {
    id: '2019-05-ignite-pearls-insight-and-creativity-in-distribute',
  ...
  {
    id: '2018-03-memory-centric-architecture-a-new-approach-to-dist',
  ...
  {
    id: '2018-04-stream-processing-best-practices-in-the-cloud-and-',
  ...
  {
    id: '2018-50-comparing-apache-ignite-and-cassandra-for-hybrid-t',
    title: "Comparing Apache\u00ae Ignite\u00ae and Cassandra\u2122 for Hybrid Transactional Applications (HTAP)",
    type: 'webinar',
    date: '2018-01-01',
    location: "Webinar",
  ...
  {
    id: '2018-60-catch-an-intro-to-the-java-powered-apache-ignite-m',
  ...
  {
    id: '2018-75-turbocharge-your-mysql-queries-in-memory-with-apac',
    title: "Turbocharge your MySQL queries in-memory with Apache Ignite",
    type: 'meetup',
    date: '2018-01-01',
    location: "The Boston MySQL Meetup Group",
  ...
  {
    id: '2017-13-fast-data-meets-big-data-in-the-iot-using-apache-i',
  ...
  {
    id: '2017-42-apache-ignite-community-meetup-an-overview-of-dona',
  ...
  {
    id: '2017-45-apache-ignite-and-apache-spark-this-is-where-fast-',
    title: "Apache Ignite and Apache Spark: This is Where Fast Data Meets the IoT",
    type: 'conference',
    date: '2017-01-01',
  ...
  {
    id: '2017-56-scalability-in-distributed-in-memory-systems-',
    title: "Scalability in Distributed In-Memory Systems",
    type: 'conference',
    date: '2017-01-01',
    location: "JBreak 2017, Novosibirsk, Russia",
    link: "https://2017.jbreak.ru/en/talks/scalability-in-distributed-in-memory-systems/",
    speakers: ["Yakov Zhdanov"],
  },
  {
  ...
  },
  {
    ...
    location: "",
    link: "/download.html",
    description: "The Apache Software Foundation (ASF), the all-volunteer developers, stewards, and incubators of more than 350 Open Source projects and initiatives, announced today that Apache\u00ae Ignite\u00ae has graduated from the Apache Incubator to become a Top-Level Project (TLP), signifying that the project's community and products have been well-governed under the ASF's meritocratic process and principles.",
  },
  {
    ...
    location: "",
    link: "/download.html",
    description: "This new release includes integration with Apache YARN for data center and resource management, fixes for JTA transactions, Hibernate L2 Cache improvements, and more.",
  },
  {
  ...
  },
  {
    ...
    location: "",
    link: "/download.html",
    description: "This new release includes shared RDD for Apache Spark (based on Ignite Data Grid), integration with Apache Mesos for data center management, client-mode for light-weight cluster discovery, memory-size eviction policy, and more.",
  },
  {
    ...
    location: "",
    link: "/download.html",
    description: "This new release includes Google Compute Engine and generic cloud TCP discovery IP finder, Collocated mode for SQL queries, support for (*) star notation in cache names, fix for SQL union support, and more.",
  },
  {
    ...
    location: "",
    link: "/download.html",
    description: "This new release includes dynamic caching functionality to start and stop caches during runtime, simplified Query API, automatic aggregation, grouping and sorting support for SQL Queries, Streaming examples, and more.",
  },
  {
    ...
    location: "",
    link: "/download.html",
    description: "This is the first release of Apache Ignite project. The source code in large part is based on the GridGain In-Memory Data Fabric, open source edition, v. 6.6.2, which was donated to Apache Software Foundation.",
  },
  {
    ...
    description: "InfoQ caught up with Nikita Ivanov, CTO and founder of GridGain, about the In-Memory Computing framework becoming an Apache project, motivation behind this decision, and upcoming features and enhancements of GridGain.",
  },
  {
