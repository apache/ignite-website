  ...
  return (
    <Layout>
      <Head>
        ...
        />
        <link rel="canonical" href="https://ignite.apache.org/features/compute-apis" />
        <meta property="og:title" content="Processing Where Data Lives - Apache Ignite" />
        <meta property="og:type" content="article" />
        <meta property="og:url" content="https://ignite.apache.org/features/compute-apis" />
      ...
      <section className="native-bottom container">
        <div className="native-bottom__grid">
          ...
          <article className="nativebotblock nativebotblock--learn">
            ...
            <a
              className="nativebotblock__link arrowlink"
              href="https://ignite.apache.org/docs/ignite3/latest/developers-guide/compute/compute"
              target="_blank"
              rel="noopener noreferrer"
            >
