...
> If you're new to Ignite 3, start with the [Java API quick start guide](https://ignite.apache.org/docs/ignite3/latest/quick-start/java-api) to set up your development environment.
...
Explore the [Ignite 3 documentation](https://ignite.apache.org/docs/ignite3/latest/) for detailed examples and API references.
